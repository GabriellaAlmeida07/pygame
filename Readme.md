...
Esse projeto é um jogo, criado para representar fenômenos específicos da física. Ele busca demonstrar os conceitos de queda livre, gravidade e viscosidade de uma forma interativa e divertida. O jogo consiste em selecionar um personagem, os quais possuem massas distintas, uma viscosidade e um ambiente que representa diferentes gravidades. Ao seleciona-los, é solicitado que o jogador tente adivinhar o tempo de queda nas condiçṍes escolhidas. Por fim, há uma animação que demonstra a queda e revela qual foi o verdadeiro tempo de queda atingido.
